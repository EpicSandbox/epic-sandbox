...
class GameState {
  ...
  updateState(user, message){
    ...
    } else if (command[0] === 'assign') {
      this.users[user].role = command[1];
      console.log(`fusers have been updated! ${this.users.toString()}`)
      console.log(`user role is: ${this.users[user].role}`)
    }
  }
};
